...
def amount_to_text(number, currency, sub):
    number = '%.2f' % number
    units_name = currency
    sub_units_name = sub
    ...
    cents_name = (cents_number > 1) and sub_units_name.capitalize() or sub_units_name.capitalize() + 's'
...
def amount_to_text(nbr, lang='en', currency='euro', sub='cent'):
    ...
    if not _translate_funcs.has_key(lang):
        ...
        lang = 'en'
    return _translate_funcs[lang](abs(nbr), currency, sub)