...
class ConsolidatedSaleOrder(models.TransientModel):
    _name = 'consolidated.sale.order'
    ...
    def print_report(self):
        ...
        return self.env['report'].get_action(self, 'hatta_reports.consolidated_sale', data=datas)


class ConsolidatedSaleOrderReport(models.AbstractModel):
    _name = 'report.hatta_reports.consolidated_sale'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('hatta_reports.consolidated_sale', docargs)
