...
class UpcomingDeliveries(models.TransientModel):
    _name = 'upcoming.deliveries'
    ...
    def print_report(self):
        ...
        return self.env['report'].get_action(self, 'hatta_reports.upcoming_deliveries', data=datas)


class PurchaseInvoiceReport(models.AbstractModel):
    _name = 'report.hatta_reports.upcoming_deliveries'
    ...
    def render_html(self, docids, data=None):
        ...
        return self.env['report'].render('hatta_reports.upcoming_deliveries', docargs)
