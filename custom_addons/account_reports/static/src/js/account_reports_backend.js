...
var account_report_generic = Widget.extend(ControlPanelMixin, {
    ...
    render_searchview_buttons: function() {
        ...
        if (this.report_context.account_ids) { // Same for the journal
        ...
        if (this.report_type.analytic && this.report_context.analytic && !this.report_type.hide_analytic_account) { // Same for the tags filter
            ...
            for (i = 0; i < this.report_context.analytic_tag_ids.length; i++) { 
                selection.push({id:this.report_context.analytic_tag_ids[i][0], text:this.report_context.analytic_tag_ids[i][1]});
            }
